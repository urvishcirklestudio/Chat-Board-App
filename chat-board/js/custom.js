$(document).ready(function () {
    ...
    UserList.forEach(({ id, Name, Thumbnail }) => {
        const User_Items = `<li class="user_items" data-User-Id="${id}"><div class="user_image"><img src="${Thumbnail}" alt="" class="image_cover"></div><div class="name_message"><h5 class="name">${Name}</h5><p class="message">message</p></div></li>`
